...
if (!dir.exists("../trajectories_ctd")) {dir.create("../trajectories_ctd")}
save(trajectories,file=paste0("../trajectories_ctd/trajectories_",id,".Rdata"))

# save infection
infections = c() # save simulated infections as code is running
if (!dir.exists("../infections_ctd")) {dir.create("../infections_ctd")}
save(infections,file=paste0("../infections_ctd/infections",id,".Rdata"))
...
transmission_model = function(seeds, params, n_tims) {
  ...
  #   expr={
      ...
      load(paste0("../trajectories_ctd/trajectories_",id,".Rdata"))
      ...
      load(paste0("../infections_ctd/infections",id,".Rdata"))
...
amis_output <- AMISforInfectiousDiseases::amis(
    ...
    prior,
    output_dir = paste0("../amis_intermittant_outputs_ctd/batch",id,"_"),
    initial_amis_vals = amis_output
)
en<-Sys.time()
dur_amis<-as.numeric(difftime(en,st,units="mins"))
if (!dir.exists("../AMIS_output_ctd")) {dir.create("../AMIS_output_ctd")}
save(amis_output,file=paste0("../AMIS_output_ctd/amis_output",id,".Rdata"))
...
if (n_failure>0) {cat(paste(failures,id,ess[failures]),file = paste0("../ESS_NOT_REACHED_ctd.txt"),sep = "\n", append = TRUE)}
